...
void showdistance()
{
  ...
  lcd.print((int)distance1d); 
  lcd.print(" cm"); 
  lcd.setCursor(0,1);
  if (devicemode == 2)
      lcd.print("(v)"); 
  lcd.print("Distance 2:"); 
  lcd.print((int)distance2d); 
  lcd.print(" cm"); 
  lcd.setCursor(0,2);
  if (devicemode == 3)
      lcd.print("(v)"); 
  lcd.print("Distance 3:"); 
  lcd.print((int)distance3d); 
  lcd.print(" cm"); 
  lcd.setCursor(0,3);
  lcd.print(""); 
  lcd.print((int)distance1d ); 
  lcd.print(" "); 
  lcd.print((long)(distance1d * distance2d) ); 
  lcd.print(" "); 
  lcd.print((long)(distance1d * distance2d*distance3d )); 
