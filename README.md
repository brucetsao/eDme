...
這本書以市面常見的超音波測距機商品為主要開發標的，從小到大，測量距離不管是使用手掌、手臂、雙臂、繩子、捲尺到最新電子測距機，都是我們常用測量距離的常用工具。所以本書要以『超音波測距機』為實驗主體，透過無線通訊控制器的開發，可以更加了解其無線控制系統，相信整個研發過程會更加了解。 
Arduino 超音波測距機設計與製作 (The Design and Development of a Distance Measurement Equipment by Using Ultrasonic Sensor by Arduino Technology)
